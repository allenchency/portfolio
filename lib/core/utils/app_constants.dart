...
abstract class AppConstants {
  ...
  static const List<CustomService> services = [
    CustomService(
      ...
      description:
          'Proficient in VSCode, but also skilled with terminal and Vim. Adaptable coding environments for high-quality results.',
    ),
    CustomService(
      service: 'DATA ANALYSIS',
      logo: AppAssets.uiDesignLogo,
      description:
          'Proficient in Python data analysis. Extract insights with Pandas, Matplotlib. Build predictive models.',
    ),
    CustomService(
      service: 'WEB DEVELOPMENT',
      logo: AppAssets.scrappingLogo,
      description:
          'I am a fresh developer in app development. I have experience using Dart and Flutter Framewor.',
    ),
  ];
  static const List<Project> projects = [
    Project(
      ...
      imageUrl:
          '',
      description:
          'A project to find the shortest route with Simulated Annealing algorithm',
      githubRepoLink: 'https://github.com/allenchency',
      previewLink: 'https://youtu.be/',
    ),
    // Project(
